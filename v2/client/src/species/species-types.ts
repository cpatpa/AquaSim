...
export const SPECIES: Record<number, SpeciesDefinition> = {
  ...
  10: { name: 'Phytoplankton',  color: '#00FF88', tier: 'producer',    layer: 1, breedRate: 0.13, desc: 'Fast-spreading base producer' },
  11: { name: 'Seaweed',        color: '#00CC44', tier: 'producer',    layer: 0, breedRate: 0.04, desc: 'Slow-growing plant, food for snails' },
  12: { name: 'Coral',          color: '#FF6EC7', tier: 'producer',    layer: 0, breedRate: 0.02, desc: 'Rare reef-builder, very slow growth' },
  20: { name: 'Shrimp',         color: '#FF9944', tier: 'herbivore',   layer: 1, breedRate: 0.09, moveRate: 0.70, hungerMax: 26, eats: [10],      desc: 'Fast-breeding plankton grazer' },
  21: { name: 'Snail',          color: '#CC88FF', tier: 'herbivore',   layer: 0, breedRate: 0.04, moveRate: 0.22, hungerMax: 36, eats: [11, 3],   desc: 'Slow-moving seaweed consumer, scavenges dead' },
  22: { name: 'Crab',           color: '#FF5533', tier: 'herbivore',   layer: 0, breedRate: 0.04, moveRate: 0.42, hungerMax: 32, eats: [10, 11, 3], desc: 'Omnivore - eats plants and dead matter' },
  23: { name: 'Sea Urchin',     color: '#BB4466', tier: 'herbivore',   layer: 0, breedRate: 0.02, moveRate: 0.18, hungerMax: 40, eats: [12],      desc: 'Slow grazer - the only coral predator' },
  30: { name: 'Small Fish',     color: '#44CCFF', tier: 'consumer',    layer: 2, breedRate: 0.06, moveRate: 0.85, hungerMax: 30, eats: [20, 10, 3], desc: 'Fast schooling fish — eats shrimp, plankton, scavenges', layerReach: 2 },
  ...
  40: { name: 'Shark',          color: '#8899CC', tier: 'apex',        layer: 3, breedRate: 0.02, moveRate: 0.90, hungerMax: 50, eats: [30, 31, 32, 20, 3], desc: 'Top predator — hunts consumers, scavenges', layerReach: 3 },
  41: { name: 'Octopus',        color: '#CC3366', tier: 'apex',        layer: 1, breedRate: 0.02, moveRate: 0.58, hungerMax: 44, eats: [30, 22, 31, 21, 3], desc: 'Cunning apex — eats anything it catches', layerReach: 2 },
  42: { name: 'Whale',          color: '#6688AA', tier: 'megafauna',   layer: 2, breedRate: 0.008, moveRate: 0.30, hungerMax: 60, eats: [10, 20, 30, 21, 3], desc: 'Filter feeder — bulk feeds on everything below', layerReach: 3 },
  43: { name: 'Dolphin',        color: '#55BBEE', tier: 'megafauna',   layer: 2, breedRate: 0.012, moveRate: 0.92, hungerMax: 42, eats: [30, 31, 20, 22], desc: 'Fast social hunter — versatile predator', layerReach: 3 },
