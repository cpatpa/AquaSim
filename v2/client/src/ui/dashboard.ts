...
const DASH_STYLES = `
  ...
  .dash-panel { background:#0A1520; border:1px solid #1A3A4B; border-radius:8px; width:700px; max-width:90vw; max-height:80vh; display:flex; flex-direction:column; }
  .dash-header { display:flex; justify-content:space-between; align-items:center; padding:16px 20px; border-bottom:1px solid #1A3A4B; }
  .dash-header h2 { font-family:'Orbitron',monospace; color:#00E5FF; font-size:1rem; letter-spacing:1px; }
  .dash-save-count { color:#4A7A8A; font-size:0.8rem; }
  .dash-close { background:none; border:none; color:#4A7A8A; font-size:1.5rem; cursor:pointer; }
  .dash-close:hover { color:#FF6B6B; }
  ...
  .dash-card { background:#0D1B2A; border:1px solid #1B3A4B; border-radius:6px; padding:12px; cursor:pointer; transition:border-color 0.2s; }
  .dash-card:hover { border-color:#00E5FF; }
  .dash-card-name { color:#7EE8FA; font-size:0.9rem; font-weight:bold; margin-bottom:4px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  .dash-card-meta { color:#4A7A8A; font-size:0.75rem; }
  .dash-card-actions { display:flex; gap:4px; margin-top:8px; }
  .dash-card-actions button { padding:3px 8px; font-size:0.7rem; border-radius:3px; border:1px solid #1B3A4B; background:#0A1520; color:#7EE8FA; cursor:pointer; font-family:inherit; }
  .dash-card-actions button:hover { background:#1B3A4B; }
  .dash-card-actions .btn-del { color:#FF6B6B; border-color:#FF6B6B33; }
  .dash-card-actions .btn-del:hover { background:#FF6B6B22; }
  .dash-empty { text-align:center; color:#4A7A8A; padding:40px 0; }
  ...
  .dash-vis-private { background:#1B3A4B; color:#4A7A8A; }
